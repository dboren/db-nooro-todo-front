...
export default function Home() {
  ...
  function deleteTask(deletionId: String) {
    ...
    axios.delete(`http://localhost:8080/api/v1/task/delete/${deletionId}`)
    .then(response => {
                    ...
                    <li key={task.id}>
                        <Link href="/task-form/edit-task-form">
                          <TaskCard
                            ...
                            {/* <h2>{task.title}</h2> */}
                            <button id={task.id}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
